...
export function CarCard({car, onClick, liked, onLike, idx}) {
  ...
  const bc = {فاخرة:"#EF4444",SUV:"#34D399",كهربائية:"#38BDF8",زفاف:"#F472B6","4×4":"#D97706",سيدان:"#A78BFA",فان:"#22C55E"}[car.badge]||"#A78BFA";
  return (
      ...
      <div style={{padding:"clamp(10px,2.5vw,14px) clamp(12px,3vw,16px)"}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:8}}>
          <div style={{flex:1,minWidth:0,paddingLeft:8}}>
            <div style={{fontSize:"var(--font-card-title,15px)",fontWeight:800,color:"#fff",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{car.name}</div>
