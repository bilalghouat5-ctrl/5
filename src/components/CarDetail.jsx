  ...
  return (
    ...
    >
      ...
      <div style={bottomBarStyle}>
        ...
        <a href={whatsappUrl()} target="_blank" rel="noreferrer" onClick={saveCurrentBooking} style={whatsappButtonStyle} aria-label="الحجز عبر واتساب">
          <IconWhatsapp size={19} color="#fff" />
        </a>
        <button onClick={confirmBooking} style={bookButtonStyle}>حجز الآن</button>
      </div>
...
const bottomBarStyle = {
  ...
  zIndex: 120,
  display: "grid",
  gridTemplateColumns: "1fr 46px minmax(118px, 36vw)",
  alignItems: "center",
  gap: 9,
...
const whatsappButtonStyle = {
  ...
  placeItems: "center",
  textDecoration: "none",
  boxShadow: "0 14px 28px rgba(34,197,94,.25)",
};
