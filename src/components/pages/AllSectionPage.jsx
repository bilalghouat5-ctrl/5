...
import { IconBack, IconLike, IconPin, IconVerified, IconGrid, IconCar } from "../ui/AppIcons.jsx";
    ...
    >
      ...
      <div style={{ padding: "clamp(12px,3vw,16px)" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", borderTop: "1px solid rgba(255,255,255,.07)", paddingTop: 10 }}>
          <span style={{ color: agency.color || "#A78BFA", fontWeight: 900, fontSize: 13, display:"inline-flex", alignItems:"center", gap:5 }}><IconCar size={13} color="currentColor" /> {agency.cars}</span>
