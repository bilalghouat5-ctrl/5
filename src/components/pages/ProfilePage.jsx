...
export function ProfilePage({ onLogout }) {
  ...
  if (pathname === "/profile/language") {
    return (
      <div dir={dir} className="tiny-ui tiny-ui-scrollpad" style={base}>
  ...
  return (
    <div dir={dir} className="tiny-ui tiny-ui-scrollpad" style={{ padding: "8px 18px 126px", animation: "fadeUp .28s ease", color: "#F7F7FA" }}>
