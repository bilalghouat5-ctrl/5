  ...
  return (
    <div
      ...
      style={{
        ...
        fontFamily: "Cairo, system-ui, sans-serif",
        direction: "rtl",
        animation: "authBackdropIn .22s ease",
      }}
    >
      <div style={{ position: "absolute", inset: 0, overflow: "hidden" }}>
        <img
          src={ROAD_IMG}
          alt=""
          style={{ width: "100%", height: "100%", objectFit: "cover", opacity: .18, filter: "blur(2px) saturate(.8)", transform: "scale(1.04)" }}
        />
      ...
      >
        ...
        <button
          onClick={close}
          style={{
            position: "absolute", top: 18, left: 16, zIndex: 30,
            width: 36, height: 36, borderRadius: "50%",
            background: "rgba(0,0,0,.42)", backdropFilter: "blur(10px)",
