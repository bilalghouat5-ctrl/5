...
import { IconLike, IconPin, IconVerified, IconCar } from "../ui/AppIcons.jsx";
        ...
        {loading
          ...
          <div key={ag.id} onClick={() => onOpen(ag)} style={{
            ...
            <div style={{ padding:"9px 10px 10px" }}>
              ...
              {ag.cars > 0 && (
                <div style={{ marginTop:5, fontSize:10, color:`${ag.color}`, fontWeight:800, display:"inline-flex", alignItems:"center", gap:4 }}><IconCar size={10} color="currentColor" /> {ag.cars}</div>
              )}
            </div>
