  ...
  return (
    <div style={{ minHeight: "100vh", background: "#050506", color: "#fff", animation: "fadeIn .32s ease", paddingBottom: 112, overflowX: "hidden" }}>
      ...
      <section style={{ padding: "0 18px" }}>
        ...
        <button onClick={() => { if (!getCurrentUser()) setGuestAuthSheet(true); else setContactSheet(true); }} type="button" style={contactButtonStyle}>
          <span style={contactButtonIconStyle}><IconPhone size={18} color="#fff" /></span>
          <span style={{ flex: 1, textAlign: "start", fontSize: 13.5, fontWeight: 950 }}>تواصل مع الوكالة</span>
