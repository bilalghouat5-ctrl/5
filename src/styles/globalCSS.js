const CSS = `
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  .tiny-ui{transform:scale(.70);transform-origin:top center;width:142.857%;margin-left:-21.428%;}
  html[dir="rtl"] .tiny-ui{margin-left:0;margin-right:-21.428%;}
  .tiny-ui img{image-rendering:auto;}
  .tiny-ui-scrollpad{padding-bottom:180px!important;}
  @supports (zoom: .7){.tiny-ui{zoom:.70;transform:none;width:100%;margin-left:0;margin-right:0;}}
