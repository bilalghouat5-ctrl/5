...
import { IconSearchSm, IconFilter, IconClose, IconPin, IconSpark, IconMap, IconDownload } from "./components/ui/AppIcons.jsx";
        ...
        <div style={{textAlign:"center",padding:"var(--hero-padding, 22px 10px 18px)",animation:"fadeUp .5s ease"}}>
          ...
          <div style={{maxWidth:"clamp(300px,90vw,520px)",margin:"0 auto",position:"relative"}}>
            ...
            <div style={{display:"flex",gap:8,overflowX:"auto",WebkitOverflowScrolling:"touch",scrollbarWidth:"none",padding:"12px 2px 0",justifyContent:"center"}}>
              ...
              <button onClick={()=>window.dispatchEvent(new Event("beforeinstallprompt"))} className="btn-press" style={{flexShrink:0,display:"flex",alignItems:"center",gap:6,border:"1px solid rgba(255,255,255,.08)",background:"rgba(255,255,255,.045)",color:"rgba(255,255,255,.58)",borderRadius:999,padding:"9px 13px",fontFamily:"inherit",fontSize:11,fontWeight:900,cursor:"pointer"}}>
                <IconDownload size={13} color="rgba(255,255,255,.5)"/>
                PWA
              </button>
            </div>
          </div>
