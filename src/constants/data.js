...
export const CARS = [
  ...
  {id:13,name:"Mercedes V-Class",     type:"van",     price:12000,rating:4.86,trips:64, reviews:59, year:2023,seats:8,wilaya:"الجزائر",  img:"https://images.unsplash.com/photo-1550355291-bbee04a92027?w=700&q=80",badge:"فان",    verified:true, fuel:"ديزل",   trans:"أوتوماتيك",freeCancel:true },
  {id:14,name:"Nissan Patrol Safari", type:"4x4",     price:18500,rating:4.91,trips:81, reviews:74, year:2022,seats:7,wilaya:"تمنراست", img:"https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=700&q=80",badge:"4×4",    verified:true, fuel:"ديزل",   trans:"أوتوماتيك",freeCancel:true },
  {id:15,name:"Hyundai Ioniq 5",      type:"electric",price:12500,rating:4.93,trips:43, reviews:39, year:2024,seats:5,wilaya:"وهران",    img:"https://images.unsplash.com/photo-1617788138017-80ad40651399?w=700&q=80",badge:"كهربائية",verified:true, fuel:"كهربائي",trans:"أوتوماتيك",freeCancel:true },
];
...
export const FOUR_X_FOUR_CARS = [
  {id:201, name:"Toyota Land Cruiser",  type:"4x4", price:16000, rating:4.9,  wilaya:"الجزائر",  img:"https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?w=600&q=85", fuel:"ديزل",   badge:"4×4", seats:7, verified:true},
  {id:202, name:"Nissan Patrol Safari", type:"4x4", price:18500, rating:4.91, wilaya:"تمنراست", img:"https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=600&q=85", fuel:"ديزل",   badge:"4×4", seats:7, verified:true},
  {id:203, name:"Jeep Wrangler",        type:"4x4", price:14500, rating:4.88, wilaya:"ورقلة",   img:"https://images.unsplash.com/photo-1544636331-e26879cd4d9b?w=600&q=85", fuel:"بنزين",  badge:"4×4", seats:5, verified:true},
  {id:204, name:"Ford Bronco",          type:"4x4", price:17500, rating:4.9,  wilaya:"غرداية",  img:"https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?w=600&q=85", fuel:"بنزين",  badge:"4×4", seats:5, verified:true},
  {id:205, name:"Mitsubishi Pajero",    type:"4x4", price:12000, rating:4.82, wilaya:"بشار",    img:"https://images.unsplash.com/photo-1519641471654-76ce0107ad1b?w=600&q=85", fuel:"ديزل",   badge:"4×4", seats:7, verified:true},
];

export const VAN_CARS = [
  {id:301, name:"Mercedes V-Class",      type:"van", price:12000, rating:4.86, wilaya:"الجزائر",  img:"https://images.unsplash.com/photo-1550355291-bbee04a92027?w=600&q=85", fuel:"ديزل",   badge:"فان", seats:8, verified:true},
  {id:302, name:"Volkswagen Multivan",   type:"van", price:10500, rating:4.84, wilaya:"وهران",    img:"https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?w=600&q=85", fuel:"ديزل",   badge:"فان", seats:7, verified:true},
  {id:303, name:"Hyundai Staria",        type:"van", price:9800,  rating:4.8,  wilaya:"قسنطينة", img:"https://images.unsplash.com/photo-1550355291-bbee04a92027?w=600&q=85", fuel:"ديزل",   badge:"فان", seats:9, verified:true},
  {id:304, name:"Renault Trafic",        type:"van", price:7600,  rating:4.72, wilaya:"سطيف",     img:"https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=600&q=85", fuel:"ديزل",   badge:"فان", seats:9, verified:false},
  {id:305, name:"Ford Tourneo Custom",   type:"van", price:8900,  rating:4.79, wilaya:"عنابة",    img:"https://images.unsplash.com/photo-1550355291-bbee04a92027?w=600&q=85", fuel:"ديزل",   badge:"فان", seats:8, verified:true},
];

export const ELECTRIC_CARS = [
  {id:401, name:"Tesla Model 3",       type:"electric", price:9000,  rating:4.95, wilaya:"قسنطينة", img:"https://images.unsplash.com/photo-1617788138017-80ad40651399?w=600&q=85", fuel:"كهربائي", badge:"كهربائية", seats:5, verified:true},
  {id:402, name:"Tesla Model Y",       type:"electric", price:11000, rating:4.97, wilaya:"قسنطينة", img:"https://images.unsplash.com/photo-1617788138017-80ad40651399?w=600&q=85", fuel:"كهربائي", badge:"كهربائية", seats:7, verified:true},
  {id:403, name:"Hyundai Ioniq 5",     type:"electric", price:12500, rating:4.93, wilaya:"وهران",    img:"https://images.unsplash.com/photo-1617788138017-80ad40651399?w=600&q=85", fuel:"كهربائي", badge:"كهربائية", seats:5, verified:true},
  {id:404, name:"BMW i4",              type:"electric", price:15000, rating:4.9,  wilaya:"الجزائر",  img:"https://images.unsplash.com/photo-1606664515524-ed2f786a0bd6?w=600&q=85", fuel:"كهربائي", badge:"كهربائية", seats:5, verified:true},
  {id:405, name:"Mercedes EQE",        type:"electric", price:17000, rating:4.92, wilaya:"الجزائر",  img:"https://images.unsplash.com/photo-1618843479313-40f8afb4b4d8?w=600&q=85", fuel:"كهربائي", badge:"كهربائية", seats:5, verified:true},
];
